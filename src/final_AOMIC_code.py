...
#     fixed_image = sitk.ReadImage("./Dataset/MNI/MNI152_T1_1mm.nii.gz")  # MNI template
    ...
    sitk.WriteImage(moving_resampled,  "../PreProcessedData/AOMIC_input/" + name.split('/')[-1])
    sitk.WriteTransform(final_transform, "../PreProcessedData/AOMIC_mask/" + os.path.splitext(name.split('/')[-1])[0] + ".tfm")

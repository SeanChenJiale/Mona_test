...
if not os.path.isdir("./PreProcessedData/SALD_input"):
    os.makedirs("./PreProcessedData/SALD_input")
#%%
...
#     fixed_image = sitk.ReadImage("./Dataset/MNI/MNI152_T1_1mm.nii.gz")  # MNI template
    ...
    sitk.WriteImage(moving_resampled,  "./PreProcessedData/SALD_input/" + name.split('/')[-1])
